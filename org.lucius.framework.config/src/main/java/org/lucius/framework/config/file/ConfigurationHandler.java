...
/**
 * The
 * <code>ConfigurationHandler</code> class implements configuration reading form
 * a
 * <code>java.io.InputStream</code> and writing to a
...
public class ConfigurationHandler {
    ...
    private int nextToken(PushbackReader pr,boolean newKey) throws IOException {
