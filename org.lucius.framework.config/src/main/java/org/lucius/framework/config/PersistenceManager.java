...
/**
 * The
 * <code>PersistenceManager</code> interface defines the API to be implemented
 * to support persisting configuration data. This interface may be implemented
 * by bundles, which support storing configuration data in different locations.
 * <p>
 ...
 * <code>service.ranking</code> service property - is used. If no pesistence
 * manager service has been registered, the platfrom file system based
...
public interface PersistenceManager {
    ...
    /**
     * Returns
     * <code>true</code> if a persisted
     * <code>Dictionary</code> exists for the given
     * <code>pid</code>.
     *
    ...
    /**
     * Returns the
     * <code>Dictionary</code> for the given
     * <code>pid</code>.
     * <p>
     ...
     * reference equation
     * <code>load(pid) != load(pid)</code> must hold
     * <code>true</code>.
     *
     ...
     * <code>IOException</code> must also be thrown if no dictionary exists for
     ...
     * <code>Dictionary</code> objects known to this persistence manager.
     * <p>
     ...
     * <p>
     * The
     * <code>Enumeration</code> returned from this method must be stable against
     * concurrent calls to either of the {@link #load(String)},
    ...
    /**
     * Stores the
     * <code>Dictionary</code> under the given
     * <code>pid</code>.
     * <p>
     ...
     * Removes the
     * <code>Dictionary</code> for the given
     * <code>pid</code>. If such a dictionary does not exist, this method has no
     * effect.
     *
     * @param pid The identifier of the dictionary to delet.
     *
     * @throws IOException If an error occurrs deleting the dictionary. This
     * exception must not be thrown if no dictionary with the given identifier
     * exists.
     */
