...
/**
 * The
 * <code>ConfigurationAdapter</code> is just an adapter to the internal
 * configuration object. Instances of this class are returned as Configuration
 * objects to the client, where each caller gets a fresh instance of this class
 * while internal Configuration objects are shared.
 */
...
public class ConfigurationAdapter implements Configuration {
    ...
    public void update(Dictionary properties) throws IOException {
        delegatee.getConfigurationManager().log(LogService.LOG_DEBUG, "update(properties={0})", new Object[]{properties});
     ...
     *
     * @throws IllegalStateException If this configuration object is not backed
     * by an active ConfigurationManager
     */
