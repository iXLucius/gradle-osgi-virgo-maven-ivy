...
abstract class ConfigurationBase {
    ...
    /**
     * Returns
     * <code>true</code> if the ConfigurationManager of this configuration is
     * still active.
     */
    boolean isActive() {
    ...
    void storeSilently() {
        try {
            ...
            configurationManager.log(LogService.LOG_ERROR, "Persisting ID {0} failed", new Object[]{getBaseId(), ioe});
        }
    }
