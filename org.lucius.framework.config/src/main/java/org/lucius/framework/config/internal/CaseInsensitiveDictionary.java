...
/**
 * The
 * <code>CaseInsensitiveDictionary</code> is a
 * <code>java.util.Dictionary</code> which conforms to the requirements laid out
 * by the Configuration Admin Service Specification requiring the property names
 * to keep case but to ignore case when accessing the properties.
 */
...
class CaseInsensitiveDictionary extends Dictionary {
    ...
    /**
     * Ensures the
     * <code>key</code> complies with the <em>symbolic-name</em>
     * production of the OSGi core specification (1.3.2):
     *
     * If the key does not comply an
     * <code>IllegalArgumentException</code> is thrown.
     *
     * @param key The configuration property key to check.
     * @throws IllegalArgumentException if the key does not comply with the
     * symbolic-name production.
     */
